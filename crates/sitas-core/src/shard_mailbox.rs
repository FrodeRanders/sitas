...
impl std::error::Error for KeyRouterCreateError {}
...
impl std::error::Error for ShardMailboxCreateError {}
...
impl std::error::Error for ShardMailboxAddressError {}
...
impl<M> std::error::Error for ShardSendError<M> {}
...
impl std::error::Error for ShardRecvError {}
...
impl<N: fmt::Debug> std::error::Error for WorkUnitMailboxCreateError<N> {}
...
impl<N: fmt::Debug> std::error::Error for WorkUnitMailboxAddressError<N> {}
