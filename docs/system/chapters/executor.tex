...
Tokio or similar third-party runtimes to keep the internals visible: wakers,
...
scheduler internals. The custom executor makes it possible to inspect how a
...
This is not preemption, though. A long poll still blocks the executor thread until the
