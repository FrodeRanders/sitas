...
\texttt{Arc<Mutex<Service\textgreater{}\textgreater{}}. A mutex would make mutation 
mechanically safe, but it would hide the runtime question that the project is trying to study:
