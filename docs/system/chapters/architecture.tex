...
Most runtime bugs are boundary bugs: a value crosses to another thread without being owned,
a reference to local state escapes a closure, a future keeps a borrowed value across \texttt{.await}, or a completion
