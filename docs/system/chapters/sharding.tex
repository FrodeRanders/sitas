...
parallelism comes from many independent shards, not from many threads mutating
the same service object. Each shard has its own executor, task queues, timers,
readiness registrations, and shard-local values.
