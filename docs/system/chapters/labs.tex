...
After running these labs, return to the walkthrough chapter and re-read the
modules. The source is easier to follow after seeing observable behavior. If a
result is surprising, use the debugging checklist from the walkthrough chapter
