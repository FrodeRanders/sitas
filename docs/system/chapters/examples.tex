...
\filepath{sharded\_index\_mailbox.rs} shows a different assembly path than \filepath{sharded\_index\_build.rs} . 
Scan tasks still run on executor shards, but they send owned \texttt{IndexMessage} batches through 
